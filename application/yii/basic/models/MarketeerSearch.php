...
class MarketeerSearch extends Marketeer
{
    ...
    public function rules()
    {
        return [
            [['id'], 'integer'],
            [['marketeer_fname', 'marketeer_mname', 'marketeer_lname', 'marketeer_birthdate', 'marketeer_contact_number'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'marketeer_fname', $this->marketeer_fname])
            ...
            ->andFilterWhere(['like', 'marketeer_contact_number', $this->marketeer_contact_number]);
