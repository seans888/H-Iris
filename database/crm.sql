...
CREATE TABLE IF NOT EXISTS `crm`.`webvisit_history` (
  ...
  `customer_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_webvisit_history_recipient1_idx` (`customer_id` ASC),
...
CREATE TABLE IF NOT EXISTS `crm`.`customer_preference` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_preference_has_recipient_recipient1_idx` (`customer_id` ASC),
...
-- -----------------------------------------------------
-- Placeholder table for view `crm`.`view1`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `crm`.`view1` (`id` INT);

-- -----------------------------------------------------
-- View `crm`.`view1`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `crm`.`view1`;
USE `crm`;
