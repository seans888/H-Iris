        ...
        <div class="box-header">
            ...
            <div class="pull-right">
                <?php BoxHeaderContent::make(BoxHeaderContent::RIGHT)
                    ->addIf($this->widget('common.components.web.widgets.GridViewToggleColumns', array('model' => $customer, 'columns' => array('first_name', 'last_name', 'email', 'company_name', 'group_id', 'sending_quota_usage', 'status', 'date_added')), true), $itemsCount)
