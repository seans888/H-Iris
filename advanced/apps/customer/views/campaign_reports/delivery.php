        ...
        <div class="box-header">
            ...
            <div class="pull-right">
                <?php BoxHeaderContent::make(BoxHeaderContent::RIGHT)
                    ...
                    ->add($this->widget('common.components.web.widgets.GridViewToggleColumns', array('model' => $deliveryLogs, 'columns' => array('subscriber.email', 'status', 'delivery_confirmed', 'message', 'date_added')), true))
