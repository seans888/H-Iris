        ...
        <div class="box-header">
            ...
            <div class="pull-right">
                <?php BoxHeaderContent::make(BoxHeaderContent::RIGHT)
                    ...
                    ->addIf(CHtml::link(IconHelper::make('glyphicon-export') . Yii::t('app', 'Export'), array('suppression_list_emails/export', 'list_uid' => $list->list_uid), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('app', 'Export'))), $itemsCount)
                            ...
                            array(
                                ...
                                'buttons'   => array(
                                    'update' => array(
                                        ...
                                        'url'       => 'Yii::app()->createUrl("suppression_list_emails/update", array("list_uid" => $data->list->list_uid, "email_uid" => $data->email_uid))',
                                        'imageUrl'  => null,
                                        'options'   => array('title' => Yii::t('app', 'Update'), 'class' => 'btn btn-primary btn-flat'),
                                    ),
                                    'delete' => array(
                                        'label'     => IconHelper::make('delete'),
                                        'url'       => 'Yii::app()->createUrl("suppression_list_emails/delete", array("list_uid" => $data->list->list_uid, "email_uid" => $data->email_uid))',
                                        'imageUrl'  => null,
